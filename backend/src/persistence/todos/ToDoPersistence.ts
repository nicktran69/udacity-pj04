...
export class ToDoPersistence {
  ...
  async updateToDoByIdAndUsrId(todoUpdate: TodoUpdate, todoId: string, userId: string): Promise<void> {
  ...
  async deleteToDoByIdAndUsrId(todoId: string, userId: string): Promise<void> {
